...
public class FrmAddSpeciality extends JDialog implements ActionListener {
	...
	public FrmAddSpeciality(JDialog f, String s, boolean b) {
		super(f, s, b);
		...
		labelType.setBounds(22, 8, 97, 15);
		workPane.add(labelType);
		cmbType.setBounds(153, 5, 126, 21);
		workPane.add(cmbType);
		labelGrade.setBounds(22, 53, 85, 15);
		workPane.add(labelGrade);
		cmbGrade.setBounds(153, 50, 126, 21);
		workPane.add(cmbGrade);
		labelEvidence.setBounds(22, 94, 85, 15);
		workPane.add(labelEvidence);
		edtEvidence.setBounds(153, 91, 126, 21);
		workPane.add(edtEvidence);

		
		this.getContentPane().add(workPane, BorderLayout.CENTER);
		this.setSize(436, 239);
		// 屏幕居中显示
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			try {
				PersonPlanUtil.specialityManager.add(student, type, grade, evidence);
				this.setVisible(false);
