...
public class FrmAddStudyTestGrade extends JDialog implements ActionListener {
	...
	public FrmAddStudyTestGrade(JFrame f, String s, boolean b) {
		super(f, s, b);
		...
		labelSubject.setBounds(20, 8, 69, 15);
		workPane.add(labelSubject);
		Gradetype.setBounds(130, 5, 126, 21);
		workPane.add(Gradetype);
		labelGrade.setBounds(20, 68, 69, 15);
		workPane.add(labelGrade);
		edtGrade.setBounds(130, 65, 126, 21);
		workPane.add(edtGrade);

		
		this.getContentPane().add(workPane, BorderLayout.CENTER);
		this.setSize(380, 257);
		// 屏幕居中显示
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel) {
			...
			try {
				PersonPlanUtil.studyTestManager.add(student, subjectId, grade);
				this.setVisible(false);
