...
public class FrmLogin extends JDialog implements ActionListener {
	...
	private JLabel labelCode = new JLabel("ÑéÖ¤Âë£º");
	Random ran = new Random();
	private int Code = ran.nextInt(10000);
	private JLabel labelCode2 = new JLabel(String.valueOf(Code));
